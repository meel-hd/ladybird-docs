---
title: Advanced Build Instructions"
---
...
- `LAGOM_TOOLS_ONLY`: Skips building libraries, utiltis and tests for [Lagom](../Meta/Lagom/ReadMe). Mostly only useful for cross-compilation.
...
For information on running host and target tests, see [Testing](Testing). The documentation there also contains useful information for debugging CI test failures.
