---
title: Qt Creator Project Configuration"
---
...
First, make sure you have a working toolchain and can build and run Ladybird. Go [here](../BuildInstructionsLadybird) for instructions for setting that up.
...
You can use `clang-format` to help you with the [style guide](../CodingStyle). Before you proceed, check that you're actually using the clang-format version specified in the style guide, as some OSes will ship other clang-format versions by default.
