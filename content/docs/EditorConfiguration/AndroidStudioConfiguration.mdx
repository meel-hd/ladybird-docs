---
title: Android Studio Project Configuration"
---
...
See the sections in the [CLionConfiguration](CLionConfiguration) for [Excluding Build Artifacts](CLionConfiguration.md#excluding-build-artifacts),
