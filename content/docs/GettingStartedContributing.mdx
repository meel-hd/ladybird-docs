---
title: Getting started contributing to Ladybird"
---
...
Carefully follow the steps outlined in the [build instructions](BuildInstructionsLadybird). If you are facing issues, consult the [troubleshooting guide](Troubleshooting) and the #build-problems channel on Discord.
...
Make sure your code meets the requirements in the [full contribution guidelines](/CONTRIBUTING) and [coding style](CodingStyle). Additionally:
